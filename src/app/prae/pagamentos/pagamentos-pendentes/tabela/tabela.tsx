...
const Tabela = ({
    ...
    // Função para determinar se é coluna de ações
                        ...
                        {estrutura.tabela.configuracoes?.pesquisar && (
                            <div className="flex-1">
                                ...
                                <div className="md:hidden flex items-center justify-between mb-4">
                                    ...
                                    {/* Botões de Ação no Mobile - Alinhados com o botão de filtro */}
                                    <div className="flex items-center gap-2">
                                        {estrutura.tabela.botoes &&
                                            estrutura.tabela.botoes.map((botao: any) => (
                                                <button
                                                    key={generateUniqueKey('botao-mobile', botao.chave)}
                                                    className="px-4 py-2 text-sm font-medium text-white bg-extra-150 hover:bg-extra-50 rounded-lg shadow-sm transition-colors duration-200"
                            ...
                            <tr>
                                {estrutura.tabela.colunas.map((item: any) => (
                                    <th
                                        ...
                                        className={`px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wider ${getAlinhamentoColuna()} ${isColunaAcoes(item.nome) ? 'w-32' : ''
                                            }`}
                                    >
                            ...
                            return (
                                <div
                                    ...
                                    className={`bg-white border border-gray-200 rounded-lg p-4 mb-4 shadow-sm ${
                                        itensSelecionados.has(item.id) ? 'ring-2 ring-blue-500 bg-blue-50' : ''
                                    }`}
                                >
                                    {estrutura.tabela.colunas.map((col: any) => {
                                        ...
                                        if (col.chave === 'acoes') {
                                            return (
                                                <div key={generateUniqueKey(cellKey, 'actions')} className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-center gap-2">
                                                    <input
                                                        type="checkbox"
                                                        className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                                        checked={itensSelecionados.has(item.id)}
                                                    ...
                                                    />
                                                    <span className="text-sm text-gray-700">Selecionar</span>
                                                </div>
                                            );
                                        } else {
                                            let label = col.nome;
